...
class AddMissingViewModel: ObservableObject {
    ...
    func sendMissing() throws {
        ...
        api.sendMissing(firstName: firstName, secondName: secondName, clothes: clothes, sex: sex, characteristics: characteristics, specCharacteristics: specCharacteristics, dateOfBirth: birthdate, image: image!, lastLocation: lastLocation, phoneNumber: phoneNumber)
    }
}
